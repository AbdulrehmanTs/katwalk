...
function Navigation() {
  ...
  return (
    <>
      <nav className="fixed top-0 w-[100%] h-[60px] bg-[#fff] px-[3%] flex justify-between items-center z-[3] shadow-md shadow-[#0000000a]     sm:h-[80px]">
        ...
        >
          <div className="pr-[10px] order-2     sm:order-[unset]">
            <IoSearchOutline onClick={() => searchToggler()} className="text-[20px] cursor-pointer" />
          </div>
          <div className="px-[10px] flex items-center border-r-[0px] border-[#e2e5ec] order-3     sm:order-[unset] sm:border-r-[1px]">
            <IoBagOutline onClick={() => cartToggler()} className="text-[20px] cursor-pointer" />
        ...
        <div
          className={`${styles.mob_menu} ${togglerClasses.join(' ')} fixed top-0 left-0 w-[100%] h-[100%]`}
        >
          <div
            className={`menu_overlay absolute top-0 left-0 w-[100%] h-[100%] bg-[#00000080] opacity-0`}
          ></div>
          <AiOutlineClose onClick={() => navigationToggler()} className="text-[26px] text-[#fff] absolute top-[15px] right-[20px]" />
          <div
            ...
            <div className="flex flex-col justify-between h-[85vh]">
              <ul>
                ...
                <li>
                  ...
                  <ul
                    className={`${styleClasses.join(' ')} overflow-hidden bg-[#c53a19a6] mx-[-20px] mt-[-1px] `}
                  >
                    <li>
                      <a
                        href="#"
                ...
                <li>
                  ...
                  <ul
                    className={`${occasionsClasses.join(' ')} overflow-hidden bg-[#c53a19a6] mx-[-20px] mt-[-1px]`}
                  >
                    <li>
                      <a
                        href="#"
                ...
                <li>
                  ...
                  <ul
                    className={`${shopAllClasses.join(' ')} overflow-hidden bg-[#c53a19a6] mx-[-20px] mt-[-1px]`}
                  >
                    <li>
                      <a
                        href="#"
        ...
        {/* cart div */}
        <div
          className={`${styles.mob_menu} ${cartToggleClasses.join(' ')} cart-box fixed top-0 left-0 w-[100%] h-[100%]`}
        >
          <div
          ...
          >
            <div className="flex justify-between border-b-[2px] border-[#ededed]">
              ...
              <div className="flex justify-end">
                <IoCloseOutline onClick={() => cartToggler()} className="text-[28px] text-[#000] mx-[0px] mb-[15px] mt-[-5px]" />
              </div>
            </div>
        ...
        <div
          className={`${styles.mob_menu} ${searchToggleClasses.join(' ')} fixed top-0 left-0 w-[100%] h-[100%]`}
        >
          <div
          ...
          <AiOutlineClose onClick={() => searchToggler()} className="text-[26px] text-[#000] absolute top-[15px] right-[20px]" />
        </div>
      </nav>
    </>
  );
