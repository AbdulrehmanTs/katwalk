...
function ModalNewAddress({
  ...
  const [selectedCountry, setSelectedCountry] = useState("اختر بلدك")

  const citySelect = useRef("")
  const [selectedCity, setSelectedCity] = useState("اختر مدينتك")
        ...
        >
          <TableHeader>
            <div className="flex justify-between">
              <span className="capitalize">عنوان جديد</span>
              <i
                onClick={() => toggleModal()}
          ...
          <CardBody>
            ...
            <div className=" flex mb-[1rem] flex-col      lg:flex-row">
              ...
              <div className="w-[100%]     lg:w-[68.75%] px-[5px]     lg:px-[15px]">
                ...
                >
                  ...
                  <div
                    ref={countrySelect}
                    className="absolute w-[100%] right-0 top-[43px] z-[1] dnone"
                  >
            ...
            <div className="h-[100%] flex justify-between flex-col">
              ...
              <div className="flex justify-end">
                ...
                <button onClick={() => toggleModal()} className="light-brown-btn text-[0.875rem] text-[#fff] h-[40px] leading-[40px] tracking-[0.5px] uppercase bg-[#c83e27] block px-[15px] m-[.25rem]">
                  حفظ
                </button>
              </div>
            </div>
