  ...
  return (
    <>
      ...
      >
        ...
        <ul
          className={`${styles.middle_menu} flex far justify-center flex-wrap px-[20px] mr-[15px] relative hidden  lg:px-[0] lg:flex`}
        >
          {/* <li>
            <a
              href="#"
          ...
          <li className={`${styles.menu_with_dropdown}`}>
            <Link href="/ar/shop">
              <a className=" text-[#000] text-[13px] leading-[15px] tracking-[0.5px] uppercase px-[15px]">
                الموضة
              </a>
            </Link>
            <ul
          ...
          <li>
            <a
              href="#"
              className="text-[#000] text-[13px] leading-[15px] tracking-[0.5px] uppercase px-[15px]"
            >
              انضمي معنا!
            </a>
          </li>
