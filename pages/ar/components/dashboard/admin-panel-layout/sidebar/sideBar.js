...
function SideBar({ active, openSidebar }) {
  return (
    <div className="w-[320px]    md:w-[267px] h-[auto] bg-[#fff] rounded-0      md:rounded-[5px] shadow-md border-[1px] border-[#ebedf2] mr-[-10px]      md:ml-0">
            ...
            <Link href="/ar/dashboard/home">
              <a
                className={`${active == "Dashboard" ? styles.active : ""
                  } w-[100%] flex items-center h-[40px] text-[#63666b] text-[0.8125rem] tracking-[0.5px] capitalize border-[#fff] border-l-[3px] taPoint3 py-[10px] px-[25px] cursor-pointer`}
              >
            ...
            <Link href="/ar/dashboard/products">
              <a
                className={`${active == "Products" ? styles.active : ""
                  } far w-[100%] flex items-center h-[40px] text-[#63666b] text-[0.8125rem] tracking-[0.5px] capitalize border-[#fff] border-l-[3px] taPoint3 py-[10px] px-[25px] cursor-pointer`}
              >
