...
function Navigation() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[125px] pt-[8px]     sm:max-w-[125px] sm:pt-[0]">
          <Link href="/ar">
        ...
        >
          ...
          <li className={`${styles.menu_with_dropdown}`}>
            <Link href="/ar/shop">
              <a className=" text-[#000] text-[13px] leading-[15px] tracking-[0.5px] uppercase px-[8px]">
                الموضة
              </a>
            </Link>
            <ul
        ...
        <div className="flex items-center">
          <div
            className={`${styles.menu_right_div} flex items-center pb-[0px]     sm:pb-[4px] sm:ml-[0]`}
          >
            <div className="pl-[6px] order-2 pb-[1px] border-r-[0px] border-[#e2e5ec]     sm:order-[unset] sm:border-r-[1px]">
              ...
              <div className="relative hidden lg:block">
                ...
                />
                <div
                  className="my-icon search w-[21px] h-[19px] cursor-pointer ml-2 relative z-4 bgAllIcon bg-[left_-24px_top_-445px]"
            ...
            <div className="px-[10px] flex items-center border-r-[0px] border-[#e2e5ec] order-3     sm:order-[unset] sm:border-r-[1px]">
                            ...
                            <div className="flex justify-between pt-[20px] pb-[20px] ">
                              ...
                              <div className="text-right">
                                <div className="flex">
                                  ...
                                  <div className="w-[26px] h-[19px] cursor-pointer bgAllIcon bg-[left_-22px_top_-37px] tScalePoint5 ml-[3px]"></div>
                                </div>
              ...
              <span className="text-[12px] ml-[7px] pt-[3px]">
                1
              </span>
            </div>
            ...
            <div className="flex flex-col justify-between h-[85vh]">
              <ul>
                ...
                <li>
                  ...
                  >
                    الموضة
                    <IoChevronDown className="text-[#ffffff80] ml-[10px]  " />
                  </a>
                  <ul
          ...
          >
            ...
            <div className="flex flex-col flex-col justify-between h-[89vh]    hidd en">
              <div className="flex justify-between pt-[20px] pb-[20px] mb-[45px] border-b-[1px] border-[#ededed]">
                <div className="max-w-[21%] max-h-[70px] px-[5px ] mt-[2px] ml-[16px]">
                  <span className="image_container">
                    <Image src={dress1} alt="ploduct image" />
                  </span>
                </div>
                <div className="flex">
                  ...
                  <div>
                    <div className="w-[20px] h-[18px] cursor-pointer bgAllIcon ml-[-2px] bg-[left_-22px_top_-37px] tScalePoint5 mt-[-1px]"></div>
                  </div>
                </div>
              </div>
